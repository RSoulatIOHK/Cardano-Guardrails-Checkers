...
try:
    ...
    for epoch in range(475,latest_epoch+1):
        ...
        # Print them in ./proto/constitutions/constitution_test_{epoch}.json format
        ...
        with open(f'./proto/constitutions/constitution_test_{parameters_dict["epoch"]}.json', 'w') as f:
